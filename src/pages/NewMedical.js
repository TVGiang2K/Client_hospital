    ...
    <div className="row">
      ...
      <div className="col-lg-5 col-md-6 col-sm-12">
        <ul className="breadcrumb float-md-right">
          ...
          <li className="breadcrumb-item active">New Medical</li>
        </ul>
      </div>
    </div>
  </div>
          ...
          <div className="body">
            ...
            <div className="row clearfix">
              ...
              <div className="col-lg-6 col-md-6">
                <p>
                  {" "}
                  <b>DC:</b> Hà Nội Phố - Đông Anh quận{" "}
                </p>
              </div>
              <div className="col-lg-4 col-md-6">
                <p>
  ...
  <div className="row clearfix">
    ...
    <div className="col-lg-4 col-md-12 col-sm-12">
      <div className="row clearfix">
        ...
        <div className="col-lg-12 col-md-6 m-t-30">
          <form
            action="https://www.wrraptheme.com/"
            method="post"
